#ifndef __CORE_ASSEMBLE_ASSEMBLE_H
#define __CORE_ASSEMBLE_ASSEMBLE_H
...
=======================BOL=========================
bol reg(ax), reg(?)		0100 00 01	41
bol reg(bx), reg(?)		0100 01 01	45
bol reg(cx), reg(?)		0100 10 01	49
bol reg(dx), reg(?)		0100 11 01	4D

bol reg(ax), memory		0100 00 10	42
bol reg(bx), memory		0100 01 10	46
bol reg(cx), memory		0100 10 10	4A
bol reg(dx), memory		0100 11 10	4E

bol reg(ax), immediate		0100 00 11	43
bol reg(bx), immediate		0100 01	11	47
bol reg(cx), immediate		0100 10 11	4B
bol reg(dx), immediate		0100 11	11	4F
